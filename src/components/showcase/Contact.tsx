    ...
    <div className="site-page-content">
      <div style={styles.header}>
        ...
        <div style={styles.socials}>
          <SocialBox icon={ghIcon} link={"https://github.com/QC20#bottom"} />
          <SocialBox
            icon={inIcon}
      ...
      <p>
        If I have managed to spark your attention with this website, and you
        would like to get in contact you can reach out to me by filling out this
        form.
      </p>
      <br />
      <p>
