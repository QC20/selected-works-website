...
const Experience: React.FC<ExperienceProps> = (props) => {
    ...
    <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div className="text-block">
                <ul>
                    ...
                    <li>
                        <p>
                            <b>
                                Created user-friendly tax appeal forms available to 1.7 million Danish citizens, {' '}
                            </b>
                                informed by a deep understanding of the business process to streamline information capture and case processing. {' '}
                        </p>
                    </li>
                </ul>
            </div>
            ...
            <div className="text-block">
                <ul>
                    <li>
                        <p>
                            <b>
                                Led agile feedback-driven development, {' '}
                            </b>
                            conducting usability testing, fostering cross-functional collaboration, and utilizing user insights to enhance the platform's user experience. 
                            Collaborated across technical, commercial, and managerial stakeholders to prioritize objectives and streamline development tasks. {' '}
                        </p>
                    </li>
                    <li>
                        <p>
                            ...
                            to derive actionable insights from user behavior, feedback, and financial metrics. Informed design decisions and product enhancements, {' '}
                            contributing to platform performance and user satisfaction. {' '}
                        </p>
                    </li>
                </ul>
            </div>       
            ...
            <div className="text-block">
                <ul>
                    <li>
                        <p>
                            <b>
                                Led empirical data collection of over a 100 participants for a high-impact research paper, {' '}
                            </b>
                            conducting extensive remote interviews to explore phone usage and app preferences, thus shaping an upcoming CHI paper.
                            Integral to research direction and insight generation, demonstrating a commitment to thorough analysis. {' '}
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            <b>
                                Co-authored usability study on novice users' use of 3D CAD software. {' '}
                            </b>
                            Conducted thorough quasi-qualitative analysis as part of an in-depth study, aimed at uncovering the intricate 
                            challenges novice users encounter in current 3D fabrication design practices. {' '}
                        </p>
                    </li>
                </ul>
            </div>
            ...
            <div className="text-block">
                <ul>
                    <li>
                        <p>
                            <b>
                                Led the iterative design process for a newly implemented chatbot, {' '}
                            </b>
                            conducting user evaluations and in-depth analysis of user feedback. Iteratively refined the chatbot's Natural Language Understanding (NLU) 
                            capabilities based on user insights to enhance user experience and usability. {' '}
                        </p>
                    </li>
                    <li>
                        <p>
                            ...
                            by designing and implementing new website components and UI elements, harmonizing them with our brand's visual identity. 
                            Integrated these enhancements into our CMS and CRM systems to elevate the user journey for our 16,000 weekly users, 
                            fostering a unified and user-centric digital ecosystem. {' '}
                        </p>
                    </li>
                    <li>
                        <p>
                            <b>
                                Facilitate and analyze group interviews {' '}
                            </b>
                            with doctors to learn and co-create prototypes and digital products. {' '}
                        </p>
                    </li>
                </ul>
            </div>
                ...
                <ul>
                    <li>
                        <p>
                            ...
                            such as interactive IQ tests, 3D CAD designs, and sensor & actuator physical setups, to support PhD students in their research projects. {' '}
                        </p>
                    </li>
                    <li>
                        <p>
                            <b>
                                Contributed to a CSCW study, {' '}
                            </b>
                            contributing to a research project exploring the start-up tech landscape in occupied regions of Palestine. Additionally,
                            facilitated on-campus workshops with visiting professors to gather insights and foster collaboration. {' '}
                        </p>
                    </li>
                </ul>
            </div>
            ...
            <div className="text-block">
                <ul>
                    <li>
                        <p>
                            <b>
                                Collaborated with senior UX designers {' '}
                            </b>
                ...
                <ul>
                    <li>
                        <p>
                            ...
                            {' '}equips you for roles in IT implementation, concept development, analysis, design, and leadership within organizations. 
                            Combining technical expertise with insights into user impact, the program stands out through its focus on advanced 
                            technical skills, concept development, programming, and empirical analysis of digital communication in organizational and 
                            societal contexts. {' '}
                        </p>
                    </li>
                    <li>
            ...
            <div style={{...styles.headerContainer, marginBottom: 20}}> {/* Add margin-bottom here */}
                <div style={styles.header}>
                    <div style={styles.headerRow}>
