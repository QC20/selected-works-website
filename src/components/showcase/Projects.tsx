...
const Projects: React.FC<ProjectsProps> = (props) => {
    return (
        <div className="site-page-content">
            ...
            <br />
            <p>
            Click on one of the sections below to discover some of my favorite projects in this field. I've spent a lot of time including 
            numerous visuals and interactive media to showcase each project. Enjoy!
            </p>
            <br />
