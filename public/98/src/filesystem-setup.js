...
// PORTFOLIO CHANGE: upstream this is the site root ("/"), because 98.js *is*
// the site. Here the 98 programs are vendored under /98/, so the read-only
// half of the filesystem is served from there — otherwise BrowserFS would look
// for /filesystem-index.json and fail to configure, and Notepad's and Sound
// Recorder's Open/Save would throw instead of just being empty.
const web_server_root_for_browserfs = "/98/";
